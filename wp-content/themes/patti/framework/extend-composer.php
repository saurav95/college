...
vc_map( array(
   ...
   "params" => array( 
      ...
      array(
         ...
         "value" => array(__("Date", "js_composer") => 'date', __("Name", "js_composer") => 'name', __("ID", "js_composer") => 'id', __("Last Modified Date", "js_composer") => 'modified', __("Random", "js_composer") => 'random'),
