...
<!--[if (gte IE 9)|(gt IEMobile 7)|!(IEMobile)|!(IE)]><!--><html <?php language_attributes(); ?> class="no-js"><!--<![endif]-->
	...
	<body <?php body_class(); ?>>
        ...
        <div class="container-fluid no-padding twelth-graduation">
            <div class="col-md-6 text-center no-padding twelth"><a class="active" href="<?php echo esc_url( home_url( '/' ) ); ?>">After 12th</a></div>
            <div class="col-md-6 text-center no-padding graduation"><a href="<?php echo esc_url( home_url( '/' ) ); ?>post-graduation">Post Graduation</a></div>
        </div>
