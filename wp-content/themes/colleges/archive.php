...
<?php echo do_shortcode( '[searchandfilter fields="state" post_types="engineering-category" types="checkbox" headings="Medical Categories"]'  ); ?>
					...
					<?php echo types_render_field( "college-location", array("raw" => "true" ) ); ?>
                 ...
                 if($featured == "Featured")
		{
            ...
            ?>
                        ...
                        <ul>
                            ...
                            { ?>
                            <li><a href="<?php the_permalink();?>"><?php echo $onefield ;?></a> </li>
                            <?php } ?>
                        </ul>
			...
			<script>
			  ...
			  jQuery(document).ready(function($){
				 $('.searchandfilter input[type="hidden"]').val();
			  });
